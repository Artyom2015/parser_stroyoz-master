...
def carts(car, url, is_file_exist):
    ...
    for item_car in item_carts:
        ...
        with open("/Users/artem/Desktop/parser_stroyoz-master/exit/pars_stat_detail.json", "w") as file:
            json.dump(status_pars_detail, file, indent=4, ensure_ascii=False)

        browser.get(url=f"https://msk.saturn.net{detail_url}")
...
def carts_items(car_item):
    ...
    with open("/Users/artem/Desktop/parser_stroyoz-master/resul_parce/msk_Saturn.json", "a", encoding="utf-8") as file:
...
while True:
    try:
        ...
        #
        try:
            with open("/Users/artem/Desktop/parser_stroyoz-master/exit/pars_stat.json") as file:
                d = json.load(file)
                file.close()
                is_file_exist1 = True
        except Exception:
        ...
        #
        try:
            with open("/Users/artem/Desktop/parser_stroyoz-master/exit/pars_stat_detail.json") as file:
                p = json.load(file)
                file.close()
                is_file_exist = True
        ...
        for section in list_categories_sections:
            ...
            with open("/Users/artem/Desktop/parser_stroyoz-master/exit/pars_stat.json", "w") as file:
        ...
        with open("/Users/artem/Desktop/parser_stroyoz-master/exit/errors.json", "a", encoding='utf-8') as file:
