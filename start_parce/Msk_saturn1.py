...
def carts(car, url, is_file_exist):
    ...
    for item_car in item_carts:
        ...
        with open("../exit/pars_stat_detail.json", "w") as file:
...
def carts_items(car_item):
    ...
    with open("../resul_parce/msk_Saturn.json", "a", encoding="utf-8") as file:
...
while True:
    try:
        ...
        #
        try:
            with open("../exit/pars_stat.json") as file:
                d = json.load(file)
                file.close()
                is_file_exist1 = True
        except Exception:
        ...
        #
        try:
            with open("../exit/pars_stat_detail.json") as file:
                p = json.load(file)
                file.close()
                is_file_exist = True
        ...
        for section in list_categories_sections:
            ...
            with open("../exit/pars_stat.json", "w") as file:
        ...
        with open("../exit/errors.json", "a", encoding='utf-8') as file:
